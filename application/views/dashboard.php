        ...
        <div class="w3-container">
            <div class="w3-dropdown-hover">
                <button class="w3-button w3-black w3-bar-item w3-button"><i class="fa fa-bars"></i></button><span
                    class="w3-bar-item">Dashboard</span>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="<?php echo $key['path']; ?>" class="button" download><i
                                    class="fa fa-download"></i></a>
                            <button onclick="getEditWindow( <?php echo $key['slno']; ?> )" class="button"><i
                                    class="fa fa-edit"></i></button>

                            <a href="<?php base_url(); ?>delete/<?php echo $key['slno']; ?>" class="button"><i
                                    class="fa fa-trash"></i></a>
                        </td>

                        <?php } else { ?>
                        <td><a href="<?php echo $key['path']; ?>" class="button" download><i
                                    class="fa fa-download"></i></a>
                            <button onclick="getEditWindow( <?php echo $key['slno']; ?>)" class="button"><i
                                    class="fa fa-edit"></i></button>
                            <a href="<?php base_url(); ?>delete/<?php echo $key['slno']; ?>" class="button"><i
